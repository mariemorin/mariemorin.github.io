...
$.fn.extend({ShakeBorder: function(opciones) {
					...
					if(opciones.shake){
						...
						shakecode=shakecode+"."+theClassShake+" {-webkit-animation-name: 'spaceboots';-webkit-animation-duration: 0.8s;-webkit-transform-origin:50% 50%;-webkit-animation-iteration-count: infinite;	-webkit-animation-timing-function: linear;}";
